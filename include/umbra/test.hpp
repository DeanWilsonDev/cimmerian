...
#define DESCRIBE(group_name, BODY)                                                                 \
  UMBRA_MAYBE_UNUSED static const bool MACRO_CAT(_test_framework_desc_reg_, __COUNTER__) = []() {  \
    Umbra::Test::TestRegistry& _registry = Umbra::Test::TestRegistry::GetInstance();                                         \
...
#define BEFORE_EACH(BODY)                                                                          \
  do {                                                                                             \
    Umbra::Test::TestRegistry::GetInstance().SetBeforeEach(                                                     \
...
#define AFTER_EACH(BODY)                                                                           \
  do {                                                                                             \
    Umbra::Test::TestRegistry::GetInstance().SetAfterEach(_test_group, +[](void* user) BODY, nullptr, nullptr); \
  } while (0)

#define BEFORE_ALL(BODY)                                                                           \
  do {                                                                                             \
    Umbra::Test::TestRegistry::GetInstance().SetBeforeAll(_test_group, +[](void* user) BODY, nullptr, nullptr); \
  } while (0)

#define AFTER_ALL(BODY)                                                                            \
  do {                                                                                             \
    Umbra::Test::TestRegistry::GetInstance().SetAfterAll(_test_group, +[](void* user) BODY, nullptr, nullptr);  \
  } while (0)
...
#define ASSERT_TRUE(cond)                                                                          \
  do {                                                                                             \
    if (!(cond))                                                                                   \
      Umbra::Test::TestFailHandlerRegistry::GetInstance().NotifyTestFail(                          \
...
#define ASSERT_NOT_EQUAL(a, b)                                                                     \
  do {                                                                                             \
    ::Umbra::Test::Assertions::assert_not_equal((a), (b), __FILE__, __LINE__);                     \
  } while (0)
